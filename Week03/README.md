...
2.4 Start wordcount program --> double click "2_3_compile_word_count.bat"
...
```
3.1 Start kafka cluster --> double click "3_1_start_cluster.bat".

3.2 Create a topic --> double click "3_2_create_streams_plaintext_input.bat"

3.3 Start producer --> double click "3_3_run_producer_wordcount.bat"
